...
export class WorkspaceSchemaFactory {
  ...
  async createGraphQLSchema(
    ...
    const executableSchemaFromCache =
      this.workspaceSchemaStorageService.getExecutableSchema(workspaceId);

    if (executableSchemaFromCache) {
      return executableSchemaFromCache;
    }
    ...
    this.workspaceSchemaStorageService.setExecutableSchema(
      workspaceId,
      executableSchema,
    );
